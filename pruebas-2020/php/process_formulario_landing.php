...
$url = 'https://api.salesup.com/integraciones/P02APE589A068-2879-4535-876F-E4FE28CA36E0';
$params = array(
    ...
    'movil' => ($telephone),
    'correo' => ($email),
    'comentarios' => ("Nuevo lead PSA 2020: Formulario Contacto Landing")." | ".("NIT: ".$nit)." | ".("Proceso Seleccion: ".$proceso_seleccion)." | ".("Numero de colaboradores: ".$numero_colaboradores)
);
...
$Subject = "Nuevo lead PSA 2020: Formulario Contacto Landing";
